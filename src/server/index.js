...
app.get("*", (req, res) => {
    var title = "Imran Portfolio | Full Stack Mern Application";
    var description =
    ...
    var thumb =
        "https://res.cloudinary.com/dlcckjhpj/image/upload/v1601190556/welcome_little_one_3_asyay6.jpg";
    var favicon =
        "https://res.cloudinary.com/dlcckjhpj/image/upload/v1601194406/ic_profile_img_zouwp0.jpg";
