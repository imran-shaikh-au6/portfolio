...
class DashboardComponent extends React.Component {
    constructor(props) {
        super(props);
        this.state = {
            tabItem: ["HOME", "SKILLS", "PROJECTS", "CONTACTS"],
            selectedItem: "HOME",
        };
    }
                        ...
                        {this.state.tabItem.map((data) => (
                            <div
                                ...
                                className={
                                    this.state.selectedItem === data
                                        ? "bottom-menu-item-selected-container"
                            ...
                            >
                                <span
                                    className={
                                        this.state.selectedItem === data
                                            ? "bottom-menu-selected-item-txt"
                                            : "bottom-menu-item-txt"
                                    }
                                >
                                    {data}
                                </span>
                ...
                <div className={"desktop-parent-container"}>
                    <div className={"menu-bar-container"}>
                        ...
                        <div className={"menu-item-container"}>
                            <a href="#" className={"menu-item-txt"}>
                                <span>HOME</span>
                            </a>
                            <a href="#skills" className={"menu-item-txt"}>
                                <span>SKILLS</span>
                            </a>
                            <a href="#projects" className={"menu-item-txt"}>
                                <span>PROJECTS</span>
                            </a>

                            <a href="#contacts" className={"menu-item-txt"}>
                                <span>CONTACTS</span>
                            </a>
                        </div>
                    </div>
                    ...
                    <div
                        id={"skills"}
                        className={"dashboard-skill-sets-container"}
                    >
                        <div className={"skills-container"}>
                            <span className={"dashboard-skills-label"}>
                                Technical Skills
                            </span>
                        </div>
                        <SkillSetsComponent />
                    ...
                    <div
                        id={"contacts"}
                        className={"contacts-parent-container"}
                    >
                        <div className={"skills-container"}>
                            <span className={"dashboard-skills-label"}>
                                Contacts
